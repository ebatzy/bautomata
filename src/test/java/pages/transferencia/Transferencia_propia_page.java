...
public class Transferencia_propia_page extends General_page {
	...
	private String TRANSFERENCIA_MENU_JSON = System.getProperty("user.home")
			+ "\\Documents\\Automatizacion BEL Web\\Resourses\\transferencia_elements.json";
	private String DATA_JSON = System.getProperty("user.home")
			+ "\\Documents\\Automatizacion BEL Web\\Resourses\\transferencia_propia_elements.json";
